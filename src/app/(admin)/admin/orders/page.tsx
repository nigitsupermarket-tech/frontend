...
export default function AdminOrdersPage() {
  ...
  // printing so only its button is disabled while the job runs (same
  // pattern as the POS orders list).
              ...
              {error ? (
                <tr>
                  <td colSpan={7} className="py-8">
                    <ErrorState message={error} retry={fetchOrders} />
                  </td>
                </tr>
              ) : isLoading ? (
                    ...
                    <td className="px-4 py-3 text-right">
                      <div className="inline-flex items-center gap-1">
                        <button
                          ...
                          title="Print invoice"
                          className="inline-flex items-center gap-1 px-2.5 py-1.5 rounded-lg text-xs font-medium text-gray-500 hover:bg-gray-100 transition-colors disabled:opacity-50"
                        >
